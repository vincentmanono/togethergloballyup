            ...
            <div class="row">
                <div class="col-12">
                    <div class="copywrite-content d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <!-- Copywrite Text -->
                        <p class="copywrite-text justify-content-center "><p  class="copywrite-text ><a href="#"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
