...
@section('content')
                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                {{-- <h6 data-animation="fadeInUp" data-delay="100ms">mount
                                    Chama</h6> --}}
            ...
            <div class="single-slide bg-img">
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                <h6 data-animation="fadeInDown" data-delay="100ms">Few steps remaining for you to achieve
                                    your goal.</h6>
                                <h2 data-animation="fadeInDown" data-delay="300ms">
                                    ...
                                    <p data-animation="fadeInDown" data-delay="500ms">
                                        One Idea Can Change Your Life Forever.I don't know your dreams...but I know you have
                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                ...
                                <p data-animation="fadeInUp" data-delay="500ms">Vestibulum eu vehicula elit, nec elementum
                                    orci. Praesent aliquet ves tibulum tempus. Pellentesque posuere pharetra turpis, eget
                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                ...
                                <p data-animation="fadeInDown" data-delay="500ms">Vestibulum eu vehicula elit, nec elementum
                                    orci. Praesent aliquet ves tibulum tempus. Pellentesque posuere pharetra turpis, eget
                                    finibus erat porta placerat.</p>
            ...
            <div class="row align-items-end">
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-features-area mb-100 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <h6>
                            togetherglobally is a simple to use web application that enables you to join online
                            merry-go-round groups to manage all activities and communications.
    ...
    <section class="cta-area d-flex flex-wrap">
        <!-- Cta Thumbnail -->
        <div class="cta-thumbnail bg-img jarallax" style="background-image: url(assets/img/bg-img/mn.jpg);"></div>
        ...
        <div class="cta-content">
            ...
            <h6>TogetherGloballyUp is a simple to utilize web application that enables you to join
    ...
    <section class="miscellaneous-area bg-gray section-padding-100-0">
        <div class="container">
            <div class="join mt-0 mb-15 border-bottom border-dark text text-bold  "> <i class="fa fa-pencil"
                    aria-hidden="true"></i> How to Join</div>
                ...
                <div class="col-12 col-md-6 col-lg-6 ">
                    <div class="add-area mb-100 wow fadeInUp row mt-0 " data-wow-delay="100ms">
                        <div class="card col-md-6 mt-0 ">
                            <div class="card-body">
                                <h4 class="card-title"> <i class="fa fa-user-plus" aria-hidden="true"> Create Account </i>
                                </h4>
                                <h2 class="text text-capitalize text-center "
                                    style="background-color: rgb(41, 45, 49); color:white; ">New account</h2>
                                <p class="card-text">
                                <div>
                                    Sign up to get connected with the champions at Online Chama using the link provided
                                    below
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary text text-capitalize "
                                                    data-dismiss="modal">Close</button>
                                                <button type="submit" class="btn btn-primary text text-capitalize ">Create
                                                    Account</button>
                                            </div>
                                        </div>
                                        </form>
                        ...
                        <div class="card col-md-6 mt-0 ">
                            <div class="card-body">
                                <h4 class="card-title text-capitalize "> <i class="fa fa-sign-in" aria-hidden="true"></i>
                                    Login </i> </h4>
                                <h2 class="text text-capitalize text-center "
                                    style="background-color: rgb(41, 45, 49); color:white; ">Sign in to Account </h2>
                                <p class="card-text">
                                <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    showing a <span class="text text-danger">red button </span> on the dashboard <span
                                        class="text text-capitalize text-bold ">"Activate my account" </span> .
                                    Click the red button. A payment popup that allows for <span
                                        class="text text-capitalize text-bold text-success ">M-PESA and PAYPAL </span>
                                    payments will show.
                                    Selecting M-PESA, a user will have to check his phone for a prompt which will require
                                    him / her
                                    to confirm the purchase process by giving out <span
                                        class="text text-capitalize text-bold text-success "> Ksh. 100/= </span>. If Paypal
                                    option is selected,
