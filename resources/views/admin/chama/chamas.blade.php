                            ...
                            <tbody>
                                @foreach ($chamas as $chama)
                                    <tr>
                                        ...
                                        <td>
                                            <a name="chama" id="" class="btn btn-primary"
                                                href="{{ route('admin.chama.show', $chama->id) }}" role="button">
                ...
                <div class="card">
                    <div class="card-body">
                          ...
                          <div class="col-lg-6 offset-3">
                               <form action="{{ route('chama.search') }}" method="post">
                              @csrf
                              <div class="form-group">
                                <label for="code">Input Chama Code</label>
                                <input type="text" name="code" id="code"  class="form-control" placeholder="Chama Code" >
                              </div>
