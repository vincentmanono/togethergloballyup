            ...
            <div class="card-header">
                <h3 class="card-title"> View Chama Details
                    ...
                    @if (! $chama->activate)
                        ...
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#activatechama">
                        Activate Chama
                        </button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Activate chama <span class="text text-capitalize text-bold" >( {{ $chama->name }}) </span>  </h5>
                                    ...
                                    <div class="modal-body">
                                        <div>
                                            Your are about to pay  <span class="text text-info" >Ksh 150.00 only</span>. Payment will be processed using Mpesa. Enter phone number below to confirm
                                        </div>
                                       <form action="{{ route('admin.activate.chama',$chama->id) }}" method="post">
                                           <div class="form-group">
                                             <label for="phone">+254</label>
                                             <input type="text" name="phone" id="phone" class="form-control" value="{{ auth()->user()->phone }}"  placeholder="Phone number" aria-describedby="helpId">
                                             <small id="helpId" class="text-muted">Change Mobile number if you need to</small>
                                           </div>
                                       </form>
                                    </div>
                    ...
                    @if (auth()->user()->role == "admin"  && ($chama->activate == 0) && ($chama->user_id == auth()->user()->id) )
                        <button type="button" class="btn btn-success ml-5" data-toggle="modal" data-target="#activatechama">
                        Activate chama
                       </button>
                            ...
                            <thead class="thead-inverse">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td  >
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-primary btn-sm mr-3 " data-toggle="modal" data-target="#openvoting">
                                              Open Voting
                                            </button>
